...
Faré aquest projecte utilitzant PyGame. Inspirat en el primer nivell del clàssic joc de **Super Mario Bros**, és un joc de plataformes on el jugador controla a Mario mente arriba a la bandera per completar el nivell.

---

## 🎯 Objectiu del Joc
L'objectiu principal és guiar a Mario a través del nivell i arribar a la bandera final.
...
### 1. IDEA
Es tracta d'un joc de **plataformes** clàssic, on el jugador controla a Mario per avançar en el nivell.
...
- **So:**
  ...
  - 🔊 **Efectes de so**: Per a saltar, etc.
